...
const DiscoverSection = () => {
    return (
        <section className="relative w-full min-h-[80vh] flex flex-col md:flex-row items-center text-black overflow-hidden rounded-b-[20px]">
            {/* ------------------- LEFT SIDE (Text) ------------------- */}
            <div className="flex flex-col justify-start w-full md:w-1/2 px-6 md:px-12 py-10 gap-6"> {/* reduced py */}
                ...
                <p className="text-base sm:text-lg md:text-xl leading-[1.6] mt-4 max-w-lg text-[#212121B2]">
            ...
            {/* ------------------- RIGHT SIDE (Image) ------------------- */}
            <div className="flex justify-center w-full md:w-1/2 px-6 md:px-12 py-6 md:py-10"> {/* reduced py */}
                <img
                    src={discoverimg}
                    alt="Blog cover"
                    className="w-[584px] h-[452px] rounded-[30px] object-cover"
                />
            </div>
        </section>
    );
